...
func TestCreateOrderSuccess(t *testing.T) {
	...
	newOrder := repository.Order{OrderId: "orderId1", Namespace: "N7", Total: 10, PostalCode: "80636", Town: "DE"}
...
func TestCreateOrderValidation(t *testing.T) {
	...
	assert.Equal(t, "Invalid request body, orderId / total / postalCode / town fields cannot be empty.", m.Message)
...
func TestCreateOrderWithoutNamespaceSuccess(t *testing.T) {
	...
	newOrder := repository.Order{OrderId: "orderId1", Total: 10, PostalCode: "80636", Town: "DE"}

	// repository gets an order with default namespace (handler adds it)
	expectedOrder := repository.Order{OrderId: "orderId1", Namespace: "default", Total: 10, PostalCode: "80636", Town: "DE"}
